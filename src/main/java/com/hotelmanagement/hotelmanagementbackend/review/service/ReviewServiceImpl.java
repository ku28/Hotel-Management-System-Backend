...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "reviews", key = "'all-p' + #pageable.pageNumber + '-s' + #pageable.pageSize")
    ...
    @Override
    @Transactional(readOnly = true)
    @Cacheable(value = "reviews", key = "'rating-' + #rating + '-p' + #pageable.pageNumber + '-s' + #pageable.pageSize")
